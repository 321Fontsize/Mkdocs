          ...
          , l = function(e, t) {
            ...
            for (var n = document.createDocumentFragment(), a = 0; a < r.length; a++)
                if ("text" === r[a].type)
                    ...
                    try {
                        t.preProcess && (d = t.preProcess(d)),
                        o.a.render(d, l, t)
                    } catch (e) {
                        if (!(e instanceof o.a.ParseError))
                            throw e;
                        t.errorCallback("KaTeX auto-render: Failed to parse `" + r[a].data + "` with ", e),
            ...
            function e(t, r) {
                for (var n = 0; n < t.childNodes.length; n++) {
                    ...
                    if (3 === o.nodeType) {
                        ...
                        a && (n += a.childNodes.length - 1,
                        t.replaceChild(a, o))
                    } else
                        1 === o.nodeType && function() {
                            var t = " " + o.className + " ";
                            -1 === r.ignoredTags.indexOf(o.nodeName.toLowerCase()) && r.ignoredClasses.every(function(e) {
