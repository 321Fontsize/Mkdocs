!function(t, e) {
    ...
    return function(t) {
        ...
        function r(a) {
            ...
            return t[a].call(n.exports, n, n.exports, r),
            n.l = !0,
            n.exports
        }
        return r.m = t,
    ...
    , function(t, e, r) {
        ...
        var a = function() {
          ...
          , i = function t(e, r) {
            ...
            var a, n = "KaTeX parse error: " + e, i = r && r.loc;
            if (i && i.start <= i.end) {
                var o = i.lexer.input;
                a = i.start;
                var s = i.end;
        ...
        var m = function t(e) {
          ...
          , u = function() {
            ...
            return e.reportNonstrict = function(t, e, r) {
                var a = this.strict;
                if ("function" == typeof a && (a = a(t, e, r)),
                a && "ignore" !== a) {
                    if (!0 === a || "error" === a)
            ...
            e.useStrictBehavior = function(t, e, r) {
                ...
                return !(!a || "ignore" === a) && (!0 === a || "error" === a || ("warn" === a ? ("undefined" != typeof console && console.warn("LaTeX-incompatible input and strict mode is set to 'warn': " + e + " [" + t + "]"),
                !1) : ("undefined" != typeof console && console.warn("LaTeX-incompatible input and strict mode is set to unrecognized '" + a + "': " + e + " [" + t + "]"),
                !1)))
            }
            ,
        ...
        function G(t, e, r) {
            ...
            var a = t.charCodeAt(0)
              , n = F[e][a];
            if (!n && t[0]in U && (a = U[t[0]].charCodeAt(0),
            n = F[e][a]),
        ...
        var St = kt
          ...
          , Tt = function(t, e) {
            ...
            if (t.unit in Mt)
                ...
                var a;
                if (a = e.style.isTight() ? e.havingStyle(e.style.text()) : e,
                "ex" === t.unit)
          ...
          , Dt = {
            ...
            mathsym: function(t, e, r, a) {
                return void 0 === a && (a = []),
                "boldsymbol" === r.font && Bt(t, "Main-Bold", e).metrics ? Ct(t, "Main-Bold", e, r, a.concat(["mathbf"])) : "\\" === t || "main" === j[e][t].font ? Ct(t, "Main-Regular", e, r, a) : Ct(t, "AMS-Regular", e, r, a.concat(["amsrm"]))
            },
            makeSpan: It,
            makeSvgSpan: Ot,
            makeLineSpan: function(t, e, r) {
                var a = It([t], [], e);
                return a.height = Math.max(r || e.fontMetrics().defaultRuleThickness, e.minRuleThickness),
            ...
            makeGlue: function(t, e) {
                var r = It(["mspace"], [], e)
                  , a = Tt(t, e);
                return r.style.marginRight = a + "em",
                r
            },
            ...
            tryCombineChars: function(t) {
                for (var e = 0; e < t.length - 1; e++) {
                    var r = t[e]
                      , a = t[e + 1];
                    r instanceof E && a instanceof E && qt(r, a) && (r.text += a.text,
        ...
        function se(t, e) {
            var r = Zt(["base"], t, e)
              , a = Zt(["strut"]);
            return a.style.height = r.height + r.depth + "em",
        ...
        function le(t, e) {
            ...
            for (var a, n = ee(t, e, "root"), i = [], o = [], s = 0; s < n.length; s++)
                if (o.push(n[s]),
                n[s].hasClass("mbin") || n[s].hasClass("mrel") || n[s].hasClass("allowbreak")) {
                    for (var l = !1; s < n.length - 1 && n[s + 1].hasClass("mspace") && !n[s + 1].hasClass("newline"); )
                        s++,
                        o.push(n[s]),
                        n[s].hasClass("nobreak") && (l = !0);
                    l || (i.push(se(o, e)),
                    o = [])
                } else
                    n[s].hasClass("newline") && (o.pop(),
                    o.length > 0 && (i.push(se(o, e)),
                    o = []),
                    i.push(n[s]));
            o.length > 0 && i.push(se(o, e)),
            r && ((a = se(ee(r, e, !0))).classes = ["tag"],
            i.push(a));
        ...
        var me = function() {
          ...
          , fe = function(t, e) {
            ...
            if ("mathtt" === r)
                return "monospace";
            var n = t.text;
            return c.contains(["\\imath", "\\jmath"], n) ? null : (j[a][n] && j[a][n].replace && (n = j[a][n].replace),
            G(n, Dt.fontMap[r].fontName, a) ? Dt.fontMap[r].variant : null)
        }
          , ge = function(t, e, r) {
            if (1 === t.length) {
                var a = ve(t[0], e);
                return r && a instanceof me && "mo" === a.type && (a.setAttribute("lspace", "0em"),
        ...
        var ye = function(t) {
          ...
          , ke = function(t, e, r) {
            var a, n = ye(r);
            if ("mathml" === r.output)
                return be(t, e, n, r.displayMode, !0);
            if ("html" === r.output) {
                var i = le(t, n);
          ...
          , Be = function(t, e) {
            var r = function() {
                ...
                var u, p, d = [], f = Me[a], g = f[0], x = f[1], v = f[2], b = v / 1e3, y = g.length;
                if (1 === y)
                    u = ["hide-tail"],
                    p = [f[3]];
                else if (2 === y)
        ...
        var Ie = function(t, e) {
            var r, a, n;
            t && "supsub" === t.type ? (r = (a = Ce(t.base, "accent")).base,
            t.base = r,
            n = function(t) {
                if (t instanceof N)
                    return t;
            ...
            if (a.isStretchy)
                ...
                var m, u;
                "\\vec" === a.label ? (m = Dt.staticSvg("vec", e),
        ...
        _t({
            ...
            htmlBuilder: function(t, e) {
                var r, a = e.style, n = e.havingStyle(a.sup()), i = Dt.wrapFragment(oe(t.body, n, e), e);
                i.classes.push("x-arrow-pad"),
                t.below && (n = e.havingStyle(a.sub()),
                (r = Dt.wrapFragment(oe(t.below, n, e), e)).classes.push("x-arrow-pad"));
                var o, s = Be(t, e), l = -e.fontMetrics().axisHeight + .5 * s.height, h = -e.fontMetrics().axisHeight - .5 * s.height - .111;
            ...
            mathmlBuilder: function(t, e) {
                ...
                if (t.body) {
                    ...
                    if (t.below) {
                        ...
                        r = new ue.MathNode("mover",[a, n])
                } else if (t.below) {
                    var o = Ee(ve(t.below, e));
                    r = new ue.MathNode("munder",[a, o])
                } else
                    r = Ee(),
                    r = new ue.MathNode("mover",[a, r]);
                return r
            }
        }),
        _t({
            ...
            handler: function(t, e) {
                ...
                var s = parseInt(n);
                if (isNaN(s))
                    throw new o("\\@char has non-numeric argument " + n);
                return {
                    type: "textord",
                    mode: r.mode,
        ...
        var Le = function(t, e) {
          ...
          , Pe = function(t, e) {
            ...
            return a.setAttribute("mathcolor", t.color),
            a
        };
        _t({
            type: "color",
        ...
        _t({
            ...
            handler: function(t) {
                ...
                var a = e.fetch();
                if (De[a.text])
                    return "\\global" !== r && "\\\\globallong" !== r || (a.text = De[a.text]),
        ...
        _t({
            ...
            handler: function(t) {
                ...
                return "\\edef" !== r && "\\xdef" !== r || (a = e.gullet.expandTokens(a)).reverse(),
        ...
        _t({
            ...
            handler: function(t) {
                var e = t.parser
                  ...
                  , n = e.gullet.popToken()
                  , i = e.gullet.popToken();
                return Fe(e, a, i, "\\\\globalfuture" === r),
        ...
        var Ve = function(t, e, r) {
          ...
          , ir = function(t, e) {
            var r, a, n = e.havingBaseSizing(), i = ar("\\surd", t * n.sizeMultiplier, er, n), o = n.sizeMultiplier, s = Math.max(0, e.minRuleThickness - e.fontMetrics().sqrtRuleThickness), l = 0, h = 0, m = 0;
            return "small" === i.type ? (t < 1 ? o = 1 : t < 1.4 && (o = .7),
            h = (1 + s) / o,
            (r = je("sqrtMain", l = (1 + s + .08) / o, m = 1e3 + 1e3 * s + 80, s, e)).style.minWidth = "0.853em",
            a = .833 / o) : "large" === i.type ? (m = 1080 * Je[i.size],
            h = (Je[i.size] + s) / o,
            l = (Je[i.size] + s + .08) / o,
        ...
        var pr = function(t, e) {
            var r, a, n = Dt.wrapFragment(oe(t.body, e), e), i = t.label.substr(1), o = e.sizeMultiplier, s = 0, l = c.isCharacterBox(t.body);
            if ("sout" === i)
            ...
            /cancel/.test(i) && (a.height = n.height,
            a.depth = n.depth),
          ...
          , dr = function(t, e) {
            ...
            return t.backgroundColor && a.setAttribute("mathbackground", t.backgroundColor),
            a
        };
        _t({
            type: "enclose",
        ...
        var yr = function(t, e) {
            var r, a, n = t.body.length, i = t.hLinesBeforeRow, s = 0, l = new Array(n), h = [], m = Math.max(e.fontMetrics().arrayRuleWidth, e.minRuleThickness), u = 1 / e.fontMetrics().ptPerEm, p = 5 * u;
            ...
            ++q) {
                ...
                if (!(a >= s)) {
                    var D = void 0;
                    (a > 0 || t.hskipBeforeAndAfter) && 0 !== (D = c.deflt(R.pregap, p)) && ((C = Dt.makeSpan(["arraycolsep"], [])).style.width = D + "em",
                    O.push(C));
                    var H = [];
                    for (r = 0; r < n; ++r) {
                        var F = l[r]
                    ...
                    O.push(H),
                    (a < s - 1 || t.hskipBeforeAndAfter) && 0 !== (D = c.deflt(R.postgap, p)) && ((C = Dt.makeSpan(["arraycolsep"], [])).style.width = D + "em",
                    O.push(C))
                }
            }
          ...
          , kr = function(t, e) {
            ...
            if (t.cols && t.cols.length > 0) {
                var o = t.cols
                  ...
                  , h = 0
                  , m = o.length;
                "separator" === o[0].type && (n += "top ",
                h = 1),
                "separator" === o[o.length - 1].type && (n += "bottom ",
                m -= 1);
                for (var c = h; c < m; c++)
                    "align" === o[c].type ? (i += wr[o[c].align],
                    l && (s += "none "),
          ...
          , Sr = function(t, e) {
            ...
            n.body.forEach(function(t) {
                ...
                if (m)
                    ...
                    var n = t.length / 2;
                    if (r < n)
                        throw new o("Too many math in a row: expected " + r + ", but got " + n,t[0])
                }
            });
            for (var c = 0; c < i; ++c) {
                var u = "r"
            ...
            return n.colSeparationType = m ? "align" : "alignat",
            n
        };
        gr({
            type: "array",
        ...
        _t({
            ...
            handler: function(t, e) {
                var r = t.parser
                  ...
                  , n = e[0];
                if ("ordgroup" !== n.type)
                    throw new o("Invalid environment name",n);
        ...
        function Tr(t, e) {
            var r, a = ge(t.body, e);
            return "minner" === t.mclass ? ue.newDocumentFragment(a) : ("mord" === t.mclass ? t.isCharacterBox ? (r = a[0]).type = "mi" : r = new ue.MathNode("mi",a) : (t.isCharacterBox ? (r = a[0]).type = "mo" : r = new ue.MathNode("mo",a),
        ...
        _t({
            ...
            handler: function(t, e) {
                var r, a = t.parser, n = t.funcName, i = e[1], o = e[0];
        ...
        var Ir = function(t, e) {
          ...
          , Or = function(t, e) {
            var r, a = Ir(t.size, e.style), n = a.fracNum(), i = a.fracDen();
            r = e.havingStyle(n);
            ...
            a.size === w.DISPLAY.size || "display" === t.size ? (u = e.fontMetrics().num1,
            p = m > 0 ? 3 * c : 7 * c,
        ...
        _t({
            ...
            handler: function(t, e) {
                var r, a = t.parser, n = t.funcName, i = e[0], o = e[1], s = null, l = null, h = "auto";
                switch (n) {
                case "\\cfrac":
                case "\\dfrac":
                case "\\frac":
        ...
        _t({
            ...
            handler: function(t) {
                var e, r = t.parser, a = t.funcName, n = t.token;
                switch (a) {
                case "\\over":
                    e = "\\frac";
                    break;
        ...
        _t({
            ...
            handler: function(t, e) {
                var r, a = t.parser, n = e[4], i = e[5], o = "atom" === e[0].type && "open" === e[0].family ? Lr(e[0].text) : null, s = "atom" === e[1].type && "close" === e[1].family ? Lr(e[1].text) : null, l = Ce(e[2], "size"), h = null;
        ...
        var Pr = function(t, e) {
            var r, a, n = e.style;
            "supsub" === t.type ? (r = t.sup ? oe(t.sup, e.havingStyle(n.sup()), e) : oe(t.sub, e.havingStyle(n.sub()), e),
            a = Ce(t.base, "horizBrace")) : a = Ce(t, "horizBrace");
            var i, o = oe(a.base, e.havingBaseStyle(w.DISPLAY)), s = Be(a, e);
        ...
        _t({
            ...
            handler: function(t, e) {
                var r, a = t.parser, n = t.funcName, i = (t.token,
                Ce(e[0], "raw").string), s = e[1];
            ...
            htmlBuilder: function(t, e) {
                ...
                for (var i in t.attributes)
                    "class" !== i && t.attributes.hasOwnProperty(i) && n.setAttribute(i, t.attributes[i]);
                return n
            },
            mathmlBuilder: function(t, e) {
                return xe(t.body, e)
        ...
        _t({
            ...
            htmlBuilder: function(t, e) {
                var r = Tt(t.height, e)
                  , a = 0;
                t.totalheight.number > 0 && (a = Tt(t.totalheight, e) - r,
            ...
            mathmlBuilder: function(t, e) {
                ...
                var a = Tt(t.height, e)
                  , n = 0;
                if (t.totalheight.number > 0 && (n = (n = Tt(t.totalheight, e) - a).toFixed(2),
        ...
        _t({
            ...
            htmlBuilder: function(t, e) {
                ...
                var a = Dt.makeSpan(["fix"], [])
                  ...
                  , i = Dt.makeSpan(["strut"]);
                return i.style.height = n.height + n.depth + "em",
        ...
        var Fr = function(t, e, r, a, n, i, o) {
          ...
          , Ur = function(t, e) {
            ...
            i = !0) : n = Ce(t, "op");
            var o, s = e.style, l = !1;
            if (s.size === w.DISPLAY.size && n.symbol && !c.contains(Vr, n.name) && (l = !0),
            n.symbol) {
            ...
            var x = 0
              , v = 0;
            return (o instanceof E || "\\oiint" === n.name || "\\oiiint" === n.name) && !n.suppressBaseShift && (x = (o.height - o.depth) / 2 - e.fontMetrics().axisHeight,
            v = o.italic),
            i ? Fr(o, r, a, e, s, v, x) : (x && (o.style.position = "relative",
            o.style.top = x + "em"),
            o)
        }
          , Gr = function(t, e) {
        ...
        _t({
            ...
            htmlBuilder: function(t, e) {
                ...
                return r.style.borderRightWidth = a + "em",
            ...
            mathmlBuilder: function(t, e) {
                ...
                return n >= 0 ? s.setAttribute("height", "+" + n + "em") : (s.setAttribute("height", n + "em"),
        ...
        _t({
            ...
            mathmlBuilder: function(t, e) {
                ...
                return n.setAttribute("mathsize", r.sizeMultiplier + "em"),
                n
            }
        }),
        _t({
        ...
        jt({
            ...
            htmlBuilder: function(t, e) {
                ...
                if (r)
                    return r(t, e);
                var a, n, i, o = t.base, s = t.sup, l = t.sub, h = oe(o, e), m = e.fontMetrics(), u = 0, p = 0, d = o && c.isCharacterBox(o);
                if (s) {
                ...
                if (a && n) {
                    u = Math.max(u, i, a.depth + .25 * m.xHeight),
                    p = Math.max(p, m.sub2);
            ...
            mathmlBuilder: function(t, e) {
                var r, a = !1;
                t.base && "horizBrace" === t.base.type && !!t.sup === t.base.isOver && (a = !0,
                r = t.base.isOver),
        ...
        jt({
            ...
            mathmlBuilder: function(t, e) {
                var r = new ue.MathNode("mi",[pe(t.text, t.mode, e)])
                  , a = fe(t, e) || "italic";
                return a !== Zr[r.type] && r.setAttribute("mathvariant", a),
                r
            }
        }),
        jt({
            ...
            mathmlBuilder: function(t, e) {
                var r, a = pe(t.text, t.mode, e), n = fe(t, e) || "normal";
                return r = "text" === t.mode ? new ue.MathNode("mtext",[a]) : /[0-9]/.test(t.text) ? new ue.MathNode("mn",[a]) : "\\prime" === t.text ? new ue.MathNode("mo",[a]) : new ue.MathNode("mi",[a]),
        ...
        _t({
            ...
            htmlBuilder: function(t, e) {
                for (var r = na(t), a = [], n = e.havingStyle(e.style.text()), i = 0; i < r.length; i++) {
                    var o = r[i];
                    "~" === o && (o = "\\textasciitilde"),
                    a.push(Dt.makeSymbol(o, "Typewriter-Regular", t.mode, n, ["mord", "texttt"]))
                }
        ...
        var na = function(t) {
          ...
          , ha = function() {
            ...
            e.lex = function() {
                ...
                if (e === t.length)
                    return new n("EOF",new a(this,e,e));
                var r = this.tokenRegex.exec(t);
                if (null === r || r.index !== e)
                    throw new o("Unexpected character: '" + t[e] + "'",new n(t[e],new a(this,e,e + 1)));
                var i = r[2] || " ";
        ...
        var fa = function(t, e, r) {
            ...
            if (!i && !r)
                throw new o("\\renewcommand{" + n + "} when command " + n + " does not yet exist; use \\newcommand");
            var s = 0;
        ...
        pa("\\dots", function(t) {
            ...
            return r in ga ? e = ga[r] : "\\not" === r.substr(0, 4) ? e = "\\dotsb" : r in j.math && c.contains(["bin", "rel"], j.math[r].group) && (e = "\\dotsb"),
            e
        });
        var xa = {
            ")": !0,
          ...
          , ya = function() {
            ...
            e._getExpansion = function(t) {
                ...
                if ("string" == typeof r) {
                    var a = 0;
                    if (-1 !== r.indexOf("#"))
                        for (var n = r.replace(/##/g, ""); -1 !== n.indexOf("#" + (a + 1)); )
                            ++a;
                    for (var i = new ha(r,this.settings), o = [], s = i.lex(); "EOF" !== s.text; )
                        o.push(s),
                        s = i.lex();
                    return o.reverse(),
                    {
          ...
          , Sa = function() {
            ...
            e.parseExpression = function(e, r) {
                for (var a = []; ; ) {
                    ...
                    var n = this.fetch();
                    if (-1 !== t.endOfExpression.indexOf(n.text))
                        break;
                    if (r && n.text === r)
                        break;
                    if (e && ia[n.text] && ia[n.text].infix)
                        break;
                ...
                return "text" === this.mode && this.formLigatures(a),
            ...
            e.handleInfixNodes = function(t) {
                ...
                if (-1 !== r && e) {
                    var n, i, s = t.slice(0, r), l = t.slice(r + 1);
            ...
            e.handleSupSubscript = function(e) {
                ...
                if (!n)
                    throw new o("Expected group after '" + a + "'",r);
                return n
            }
            ,
            ...
            e.parseAtom = function(t) {
                ...
                for (; ; ) {
                    ...
                    if ("\\limits" === n.text || "\\nolimits" === n.text) {
                        ...
                        if (e)
                            throw new o("Double superscript",n);
                        e = this.handleSupSubscript("superscript")
                    } else if ("_" === n.text) {
                        if (r)
                            throw new o("Double subscript",n);
            ...
            e.parseSizeGroup = function(t) {
                ...
                if (!At(n))
                    throw new o("Invalid unit: '" + n.unit + "'",e);
                return {
                    type: "size",
                    mode: this.mode,
                    value: n,
            ...
            e.parseSymbol = function() {
                ...
                ka.hasOwnProperty(e[0]) && !j[this.mode][e[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + e[0] + '" used in math mode', t),
                e = ka[e[0]] + e.substr(1));
                var i, s = sa.exec(e);
                ...
                j[this.mode][e]) {
                    ...
                    var l, h = j[this.mode][e].group, m = a.range(t);
        ...
        var Aa = function(t, e, r) {
            ...
            return a.setAttribute("title", t.toString()),
